---
title: Building cloud software? Don't forget about this ...
description:
date: 2021-03-22
tags:
  - blog
...
- should I use microservices and how many
- how will these microservices communicate
- how will data persist
- what guarantees must be provided for messages flowing through the system
- what's encrypted, where and when
- etc.
...
have at least 3 instances so our brain doesn't get split, and monitor with the
EFK stack. Great! Let's write some code.
...
1,000,000 messages piled up after 5 minutes ... _assuming your two
remaining zones are still keeping up with their own load_. What if your
